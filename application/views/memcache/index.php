<div class="header">
            ...
            <h1 class="page-title"><?php echo $this->lang->line('_Memcache'); ?> <?php echo $this->lang->line('_Health Monitor'); ?></h1>
</div>
        
<ul class="breadcrumb">
            <li><a href="<?php echo site_url(); ?>"><?php echo $this->lang->line('home'); ?></a> <span class="divider">/</span></li>
            <li class="active"><?php echo $this->lang->line('_Memcache Monitor'); ?></li><span class="divider">/</span></li>
...
<form name="form" class="form-inline" method="get" action="" >
  ...
  <a href="<?php echo site_url('Memcache/health') ?>" class="btn btn-warning"><i class="icon-repeat"></i> <?php echo $this->lang->line('reset'); ?></a>
...
<div class="well">
    <table class="table table-hover table-condensed ">
      ...
      <tr style="font-size: 12px;">
		<th colspan="1"><center><?php echo $this->lang->line('servers'); ?></center></th>
        <th colspan="5"><center><?php echo $this->lang->line('basic_info'); ?></center></th>
		<th colspan="1"><center><?php echo $this->lang->line('connections'); ?></center></th>
		...
		<th><?php echo $this->lang->line('keys'); ?></th>
		<th><?php echo $this->lang->line('current'); ?></th>
    	<th><?php echo $this->lang->line('network_bytesIn_persecond'); ?></th> 
		<th><?php echo $this->lang->line('network_bytesOut_persecond'); ?></th>
        <th><?php echo $this->lang->line('opcounters_get_persecond'); ?></th>
		<th><?php echo $this->lang->line('opcounters_set_persecond'); ?></th>
		<th><?php echo $this->lang->line('evictions'); ?></th>
    	<th><?php echo $this->lang->line('opcounters_get_rate'); ?></th>
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td><?php echo check_value($item['curr_items']) ?></td>
        <td><?php echo check_value($item['curr_connections']) ?></td>
        <td><?php echo format_kbytes($item['network_bytesIn_persecond']) ?></td>
        <td><?php echo format_kbytes($item['network_bytesOut_persecond']) ?></td>
        <td><?php echo check_value($item['opcounters_get_persecond']) ?></td>
        <td><?php echo check_value($item['opcounters_set_persecond']) ?></td>
        <td><?php echo check_value($item['evictions']) ?></td>
        <td><?php echo check_value(number_format($item['opcounters_get_rate']/100,2)) ?></td>
       
        <td><?php if($item['connect']=='1'){ ?><a href="<?php echo site_url('memcache/chart/'.$item['server_id']) ?>"><img src="./images/chart.gif"/></a> <?php }else{  ?>--- <?php } ?></td>
	</tr>
 <?php endforeach;?>
 <?php }else{  ?>
<tr>
