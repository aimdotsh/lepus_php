...
<div class="well">
   ...
   <hr />
    ...
    <div class="controls">
        ...
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_warning'); ?>&nbsp;<input type="text" id="threshold_warning_used_memory" class="input-small" placeholder="" name="threshold_warning_used_memory" value="2048" >
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_critical'); ?>&nbsp;<input type="text" id="threshold_critical_used_memory" class="input-small" placeholder="" name="threshold_critical_used_memory" value="10000" >
    </div>
   </div>
