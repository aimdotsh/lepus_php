...
<div class="well">
  ...
  <div class="control-group">
    <label class="control-label" for=""><?php echo $this->lang->line('used_memory'); ?> <?php echo $this->lang->line('alarm'); ?></label>
    <div class="controls">
        <select name="alarm_used_memory" id="alarm_used_memory" class="input-small">
         <option value="1" <?php echo set_selected(1,$record['alarm_used_memory']) ?>  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0" <?php echo set_selected(0,$record['alarm_used_memory']) ?>  ><?php echo $this->lang->line('off'); ?></option>
        </select>
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_warning'); ?>&nbsp;<input type="text" id="threshold_warning_used_memory" class="input-small" placeholder="" name="threshold_warning_used_memory" value="<?php echo $record['threshold_warning_used_memory']; ?>" >
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_critical'); ?>&nbsp;<input type="text" id="threshold_critical_used_memory" class="input-small" placeholder="" name="threshold_critical_used_memory" value="<?php echo $record['threshold_critical_used_memory']; ?>" >
    </div>
   </div>
