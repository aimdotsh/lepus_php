    ...
    <div class="navbar" <?php if($this->input->cookie('lang_current')=='zh-hans') echo  "style='font-family: 微软雅黑;'" ?>>
        <div class="navbar-inner">
                <ul class="nav pull-right">
                    ...
                    <li <?php if($model=='redis'){ echo "class='active'";} ?>><a href="<?php echo site_url('redis/index'); ?>" class="hidden-phone visible-tablet visible-desktop" role="button">Memcache</a></li>
  ...
  <div class="main">
       <?php echo $content_for_layout ; ?>
                    ...
                    <footer>
                        ...
                        <p class="pull-right">Power by <a href="https://github.com/speedocjx" target="_blank">Lepus modifyed by chang</a></p>

                        <p>&copy; 2016 <a href="https://github.com/speedocjx" target="_blank">Lepus modifyed by chang</a>(天兔数据库监控系统)</p>
                    </footer>
