...
<form name="form" class="form-inline" method="get" action="" >
  ...
  <a href="<?php echo site_url('redis/health') ?>" class="btn btn-warning"><i class="icon-repeat"></i> <?php echo $this->lang->line('reset'); ?></a>
...
<div class="well">
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td><?php if($item['connect']=='1'){ ?><a href="<?php echo site_url('redis/chart/'.$item['server_id']) ?>"><img src="./images/chart.gif"/></a> <?php }else{  ?>--- <?php } ?></td>
	</tr>
 <?php endforeach;?>
 <?php }else{  ?>
<tr>
