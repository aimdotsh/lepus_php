...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_SQLServer'); ?> <?php echo $this->lang->line('batch_add'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('servers_sqlserver/batch_add') ?>" >
...
<input type="hidden" name="ids[]" value="<?php echo $n ?>" /> 
    <tr style="font-size:12px;">
        ...
        <td><input type="text" name="port_<?php echo $n ?>" class="input-mini" placeholder="<?php echo $this->lang->line('port'); ?>" value="1433"></td>
        ...
        <td><select name="alarm_processes_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
        <td><select name="alarm_processes_running_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
        <td><select name="alarm_processes_waits_<?php echo $n ?>"  class="input-mini">
         <option value="1"  ><?php echo $this->lang->line('on'); ?></option>
         <option value="0"  ><?php echo $this->lang->line('off'); ?></option>
        </select></td>
	</tr>
