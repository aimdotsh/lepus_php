...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_SQLServer'); ?> <?php echo $this->lang->line('trash'); ?></h1>
</div>
...
<div class="well">
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
		...
		<td><?php echo check_on_off($item['alarm_processes']) ?></td>
		<td><?php echo check_on_off($item['alarm_processes_running']) ?></td>
		<td><?php echo check_on_off($item['alarm_processes_waits']) ?></td>
        <td><a href="<?php echo site_url('servers_sqlserver/recover/'.$item['id']) ?>" title="<?php echo $this->lang->line('recover'); ?>"><i class="icon-repeat"></i></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo site_url('servers_sqlserver/forever_delete/'.$item['id']) ?>" class="confirm_delete" title="<?php echo $this->lang->line('forever_delete'); ?>" ><i class="icon-remove"></i></a></td>
	</tr>
 <?php endforeach;?>
<tr>
<td colspan="11">
