...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_Memcache'); ?> <?php echo $this->lang->line('trash'); ?></h1>
</div>
...
<div class="btn-toolbar">
    <a class="btn btn " href="<?php echo site_url('servers_memcache/index') ?>"><i class="icon-list"></i> <?php echo $this->lang->line('list'); ?></a>
...
<div class="well">
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td><a href="<?php echo site_url('servers_memcache/recover/'.$item['id']) ?>" title="<?php echo $this->lang->line('recover'); ?>"><i class="icon-repeat"></i></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo site_url('servers_memcache/forever_delete/'.$item['id']) ?>" class="confirm_delete" title="<?php echo $this->lang->line('forever_delete'); ?>" ><i class="icon-remove"></i></a></td>
	</tr>
 <?php endforeach;?>
<tr>
<td colspan="11">
