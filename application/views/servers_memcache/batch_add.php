...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_Memcache'); ?> <?php echo $this->lang->line('batch_add'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('servers_memcache/batch_add') ?>" >
...
<input type="hidden" name="ids[]" value="<?php echo $n ?>" /> 
    <tr style="font-size:12px;">
        ...
        <td><input type="text" name="port_<?php echo $n ?>" class="input-mini" placeholder="<?php echo $this->lang->line('port'); ?>" value="11211"></td>
