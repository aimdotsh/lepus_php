...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_Memcache'); ?> <?php echo $this->lang->line('edit'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('servers_memcache/edit') ?>" >
