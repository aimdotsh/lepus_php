...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_Memcache'); ?> <?php echo $this->lang->line('add'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('servers_memcache/add') ?>" >
...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="port" value="<?php echo set_value('port','11211'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
