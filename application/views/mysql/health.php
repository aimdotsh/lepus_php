...
<div class="header">
            ...
            <h1 class="page-title"><?php echo $this->lang->line('_Health Monitor'); ?></h1>
</div>
...
<form name="form" class="form-inline" method="get" action="<?php echo site_url('mysql/health') ?>" >
 <select name="application_id" class="input-small" style="width: 120px;">
  ...
  <option value=""><?php echo $this->lang->line('connected'); ?></option>
  ...
  <option value=""><?php echo $this->lang->line('running'); ?></option>
  ...
  <option value="threads_running" <?php if($setval['order']=='threads_running') echo "selected"; ?> ><?php echo $this->lang->line('running'); ?></option>
  <option value="threads_connected" <?php if($setval['order']=='threads_connected') echo "selected"; ?> ><?php echo $this->lang->line('connected'); ?></option>
...
<div class="well">
    <table class="table table-hover table-condensed ">
      <thead>
        ...
        <th colspan="3"><center><?php echo $this->lang->line('basic'); ?></center></th>
		<th colspan="2"><center><?php echo $this->lang->line('thread'); ?></center></th>
        ...
        <th><?php echo $this->lang->line('running'); ?></th>
        <th><?php echo $this->lang->line('bytes_received'); ?></th>
        <th><?php echo $this->lang->line('bytes_sent'); ?></th>
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
		...
		<td><?php if($item['connect']=='1'){ ?> <span class="label label-success"><?php echo $this->lang->line('up'); ?></span> <?php }else{  ?><span class="label label-important"><?php echo $this->lang->line('down'); ?></span> <?php } ?></td>
        ...
        <td><?php echo check_value($item['bytes_received_persecond']) ?>KB</td>
