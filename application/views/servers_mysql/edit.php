...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
        ...
        &nbsp;&nbsp;<?php echo $this->lang->line('repl_channel'); ?>&nbsp;<input type="text" id="repl_channel" class="input-small" placeholder="" name="repl_channel" value="<?php echo $record['repl_channel']; ?>" >
    </div>
    </div>
