<?php 
class Servers_memcache_model extends CI_Model{

    protected $table='db_servers_memcache';
	...
	*/
	public function db_status_remove($id){
		...
		$this->db->where('db_type', 'memcache');
		$this->db->delete('db_status');
	}
    
}

/* End of file servers_memcache_model.php */
/* Location: ./application/models/servers_memcache_model.php */
